...
static uint8_t mem2base[MEM2_MAX_SIZE] __attribute__((aligned(64))) __attribute__((section(".bss.ARM.__at_0x70000000")));   /* XSPI2 HyperRAM内存池,LTDC使用前1280 * 800 * 2=0x1F4000字节空间 */
...
static MT_TYPE mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((section(".bss.ARM.__at_0x70787878")));                     /* XSPI2 HyperRAM内存池MAP */
#else
static MT_TYPE mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((section(".bss.ARM.__at_0x71E1E1E0")));                     /* XSPI2 HyperRAM内存池MAP */
#endif
