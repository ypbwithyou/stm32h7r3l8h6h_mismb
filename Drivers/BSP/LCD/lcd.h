...
#define LCD_WR_GPIO_PIN             GPIO_PIN_2
...
#define LCD_RD_GPIO_CLK_ENABLE()    do { __HAL_RCC_GPIOA_CLK_ENABLE(); } while (0)
...
#define LCD_RS_GPIO_CLK_ENABLE()    do { __HAL_RCC_GPIOE_CLK_ENABLE(); } while (0)
...
#define LCD_FMC_AX                 15      /* 使能FMC_A18连接LCD_RS，范围：0~25 */
