/**
  ******************************************************************************
  * @file      startup_stm32h7r3xx.s
  * @author    MCD Application Team / GCC port
...
Reset_Handler:
  ldr   sp, =__initial_sp /* set stack pointer */
...
* to mark section as vectors, must be placed on this first vector section.
*
******************************************************************************/
...
g_pfnVectors:
  ...
  .word 0                           /* Reserved */
  .word 0                           /* Reserved */
  .word TAMP_IRQHandler             /* Tamper and TimeStamp interrupts through EXTI Line detection */
  .word 0                           /* Reserved */
  .word 0                           /* Reserved */
  ...
  .word RTC_IRQHandler              /* RTC wakeup and alarm interrupts through EXTI Line detection */
  .word 0                           /* Reserved */
  .word 0                           /* Reserved */
